...
extern int execute_query(sqlite3 *db, const char *sql_stmt, std::string table);
...
extern int create_user_table_entry(sqlite3 *db, std::string jstr, std::string server);
